(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [813],
  {
                  ...
                  children: [
                    o.map((t, s) =>
                      (0, r.jsx)(
                        ...
                        {
                          className:
                            "absolute inset-0 transition-opacity duration-1000 ".concat(
                              s !== e || a ? "opacity-0" : "opacity-100",
                            ),
                                ...
                                children: (0, r.jsxs)("div", {
                                  ...
                                  children: [
                                    ...
                                    (0, r.jsxs)("p", {
                                      ...
                                      children: [t.organizer, " \xb7 ", t.year],
                                    }),
                                    (0, r.jsx)("p", {
                            ...
                            children: o.map((a, s) =>
                              (0, r.jsx)(
                                "button",
                                {
                                  onClick: () => t(s),
                                  className:
                                    "w-2 h-2 rounded-full transition-all duration-300 ".concat(
                                      s === e
                                        ? "bg-orange-500 w-6"
                                        : "bg-gray-500 hover:bg-gray-400",
                                    ),
                                  "aria-label": "View award ".concat(s + 1),
                                },
                                s,
                              ),
                            ),
    ...
    8004: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 1504)),
        Promise.resolve().then(a.bind(a, 5494)),
        Promise.resolve().then(a.bind(a, 9495));
    },
    9495: (e, t, a) => {
      "use strict";
      a.d(t, { default: () => l });
                          ...
                          (0, r.jsx)("div", {
                            className:
                              "\n                                absolute top-0 left-0 right-0\n                                bg-gradient-to-b from-zinc-900/95 to-black/95\n                                rounded-lg border border-orange-400/30\n                                transition-all duration-300 ease-in-out\n                                shadow-[0_0_20px_rgba(74,222,128,0.4)]\n                                z-20\n                                \n                                /* Desktop hover behavior */\n                                opacity-0 group-hover:opacity-100 \n                                pointer-events-none group-hover:pointer-events-auto\n                                \n                                /* Height adjustments - taller on mobile */\n                                h-0 group-hover:h-[200px]\n                                md:group-hover:h-[210px] lg:group-hover:h-[220px]\n                                \n                                /* Mobile touch behavior override using state */\n                                "
                                .concat(
                                  e === s
                                    ? "opacity-100 h-[220px] pointer-events-auto"
                                    : "",
                            ...
                            children: (0, r.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, r.jsxs)("a", {
                                  ...
                                  className:
                                    "inline-flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-xs rounded-lg  hover:from-orange-600 hover:to-orange-700 transition-all duration-300 hover:shadow-[0_0_10px_rgba(74,222,128,0.4)] w-full justify-center mt-auto",
                                  onClick: (e) => {
                                    e.stopPropagation();
                                  },
                                  children: [
                ...
                (0, r.jsx)("div", {
                  ...
                  children: (0, r.jsxs)(n(), {
                    ...
                    className:
                      "inline-flex items-center px-4 py-2 sm:px-5 sm:py-2.5  bg-gradient-to-r from-orange-500/20 to-orange-600/10 hover:from-orange-500/30 hover:to-orange-600/20 border border-orange-500/40 hover:border-orange-400/60 rounded-lg text-orange-400 hover:text-orange-300  shadow-sm hover:shadow-[0_0_15px_rgba(255,165,0,0.4)]  transition-all duration-300 text-sm sm:text-base",
                    children: [
                      (0, r.jsx)("span", { children: "Become a sponsor" }),
                      (0, r.jsx)("svg", {
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [874, 63, 265, 441, 684, 358], () => t(8004)), (_N_E = e.O());
  },
]);
