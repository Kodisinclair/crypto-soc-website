(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_50d9d80f._.js", {

"[project]/src/config/nzGeoData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "newZealandGeoJson": (()=>newZealandGeoJson)
});
const newZealandGeoJson = {
    type: 'Feature',
    properties: {
        name: 'New Zealand',
        code: 'NZL',
...
"[project]/src/app/(home)/Map/Map.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '@/config/cityMapData'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$nzGeoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/nzGeoData.ts [app-client] (ecmascript)");
;
...
const InteractiveMap = ()=>{
    _s();
    const [mounted, setIsMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InteractiveMapClient, {}, void 0, false, {
        fileName: "[project]/src/app/(home)/Map/Map.tsx",
        lineNumber: 34,
        columnNumber: 12
    }, this);
};
_s(InteractiveMap, "obw4QpJ5EQ/Q36GN7ZoJJaQ5Jcs=");
_c = InteractiveMap;
const InteractiveMapClient = ()=>{
    ...
    const popupCardsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const activePopupRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // @ts-expect-error @TODO FIX AT SOME STAGE
    const laserIntervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])();
    const [dimensions, setDimensions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        width: 800,
        height: 1000
    }) // Reduced from 900x1120
    ;
    // Update the pixelSize calculation to use larger pixel values
    const pixelSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InteractiveMapClient.useMemo[pixelSize]": ()=>{
    ...
    const projection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InteractiveMapClient.useMemo[projection]": ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$geo$2f$src$2f$projection$2f$mercator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__geoMercator$3e$__["geoMercator"])().center([
                173,
                -41
            ]).scale(baseScale)// More subtle vertical positioning adjustment
            .translate([
                dimensions.width / 2,
                dimensions.height * verticalPosition
            ]);
        }
    }["InteractiveMapClient.useMemo[projection]"], [
        dimensions
    ...
    const path = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InteractiveMapClient.useMemo[path]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$geo$2f$src$2f$path$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__geoPath$3e$__["geoPath"])().projection(projection)
    }["InteractiveMapClient.useMemo[path]"], [
        projection
    ]);
    ...
    const handleResize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[handleResize]": ()=>{
            const debounce = {
                "InteractiveMapClient.useCallback[handleResize].debounce": (fn, ms = 250)=>{
                    let timeoutId;
                    return ({
                        "InteractiveMapClient.useCallback[handleResize].debounce": function(...args) {
                            clearTimeout(timeoutId);
                            timeoutId = setTimeout({
                                "InteractiveMapClient.useCallback[handleResize].debounce": ()=>fn.apply(this, args)
                            }["InteractiveMapClient.useCallback[handleResize].debounce"], ms);
                        }
                    })["InteractiveMapClient.useCallback[handleResize].debounce"];
                }
            }["InteractiveMapClient.useCallback[handleResize].debounce"];
            const resizeMap = debounce({
                "InteractiveMapClient.useCallback[handleResize].resizeMap": ()=>{
                    if (mapRef.current) {
            ...
            }["InteractiveMapClient.useCallback[handleResize].resizeMap"], 250);
            window.addEventListener('resize', resizeMap);
            resizeMap() // Call once to set initial dimensions
            ;
            return ({
                "InteractiveMapClient.useCallback[handleResize]": ()=>window.removeEventListener('resize', resizeMap)
            })["InteractiveMapClient.useCallback[handleResize]"];
        }
    }["InteractiveMapClient.useCallback[handleResize]"], []);
    // Laser beam logic
    const distance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[distance]": (p1, p2)=>{
            const dx = p1[0] - p2[0];
            const dy = p1[1] - p2[1];
            return Math.sqrt(dx * dx + dy * dy);
        }
    }["InteractiveMapClient.useCallback[distance]"], []);
    const getHeatValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[getHeatValue]": (point)=>{
            let maxHeat = 0;
            cities.forEach({
                "InteractiveMapClient.useCallback[getHeatValue]": (city)=>{
                    const cityPoint = projection(city.coords);
                    const dist = distance([
                        point[0],
                        point[1]
                    ], cityPoint);
            ...
            }["InteractiveMapClient.useCallback[getHeatValue]"]);
            return maxHeat;
        }
    }["InteractiveMapClient.useCallback[getHeatValue]"], [
        projection,
    ...
    const getRandomCityPair = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[getRandomCityPair]": ()=>{
            const cityIndexes = Array.from({
                length: cities.length
            }, {
                "InteractiveMapClient.useCallback[getRandomCityPair].cityIndexes": (_, i)=>i
            }["InteractiveMapClient.useCallback[getRandomCityPair].cityIndexes"]);
    ...
    const createLaserElement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[createLaserElement]": (x1, y1, x2, y2)=>{
    ...
    }["InteractiveMapClient.useCallback[createLaserElement]"], []);
    const shootRandomLaser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[shootRandomLaser]": ()=>{
            if (!mapRef.current || !svgRef.current) return;
            const { from, to } = getRandomCityPair();
            const [fromX, fromY] = projection(from.coords);
            const [toX, toY] = projection(to.coords);
            ...
            }["InteractiveMapClient.useCallback[shootRandomLaser]"], 400);
        }
    }["InteractiveMapClient.useCallback[shootRandomLaser]"], [
        projection,
        getRandomCityPair,
    ...
    const cleanupPopups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[cleanupPopups]": ()=>{
            popupCardsRef.current.forEach({
                "InteractiveMapClient.useCallback[cleanupPopups]": (card)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InteractiveMapClient.useEffect": ()=>{
            const mapRefCurrent = mapRef.current;
            const handleScroll = {
                "InteractiveMapClient.useEffect.handleScroll": ()=>{
            ...
            mapRefCurrent?.addEventListener('scroll', handleScroll, {
                passive: true
            });
            return ({
                "InteractiveMapClient.useEffect": ()=>{
    ...
    const showPopupCard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[showPopupCard]": (cityName, pinRect)=>{
            // Clean up any existing popup
            cleanupPopups();
            // Find the city data
            const city = cities.find({
                "InteractiveMapClient.useCallback[showPopupCard].city": (c)=>c.name === cityName
            }["InteractiveMapClient.useCallback[showPopupCard].city"]);
        ...
        `;
            ...
            if (closeButton) {
                closeButton.addEventListener('click', {
                    "InteractiveMapClient.useCallback[showPopupCard]": (e)=>{
                        e.stopPropagation();
                        cleanupPopups();
                    }
                }["InteractiveMapClient.useCallback[showPopupCard]"]);
            }
            // Show the card
            requestAnimationFrame({
                "InteractiveMapClient.useCallback[showPopupCard]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InteractiveMapClient.useEffect": ()=>{
            const handleDocumentClick = {
                "InteractiveMapClient.useEffect.handleDocumentClick": (e)=>{
                    ...
                    const isMarkerClick = markersRef.current.some({
                        "InteractiveMapClient.useEffect.handleDocumentClick.isMarkerClick": (marker)=>marker.contains(target)
                    }["InteractiveMapClient.useEffect.handleDocumentClick.isMarkerClick"]);
                    const isPopupClick = popupCardsRef.current.some({
                        "InteractiveMapClient.useEffect.handleDocumentClick.isPopupClick": (popup)=>popup.contains(target)
                    }["InteractiveMapClient.useEffect.handleDocumentClick.isPopupClick"]);
                    if (!isMarkerClick && !isPopupClick) {
                        cleanupPopups();
                    }
                }
            }["InteractiveMapClient.useEffect.handleDocumentClick"];
    ...
    const createCityMarkers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[createCityMarkers]": ()=>{
            if (!mapRef.current) return;
            // Clean up existing markers and popups
            markersRef.current.forEach({
                "InteractiveMapClient.useCallback[createCityMarkers]": (marker)=>marker.remove()
            }["InteractiveMapClient.useCallback[createCityMarkers]"]);
            markersRef.current = [];
            cleanupPopups();
            cities.forEach({
                "InteractiveMapClient.useCallback[createCityMarkers]": (city)=>{
                ...
                `;
                        ...
                        pinContainer.addEventListener('click', {
                            "InteractiveMapClient.useCallback[createCityMarkers]": (e)=>{
                                e.stopPropagation();
    ...
    // Render the map
    const renderMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InteractiveMapClient.useCallback[renderMap]": ()=>{
            if (!mapRef.current) return;
            // Clean up
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"])(mapRef.current).select('svg').remove();
            const lasers = mapRef.current.querySelectorAll('.laser-beam');
            lasers.forEach({
                "InteractiveMapClient.useCallback[renderMap]": (laser)=>laser.remove()
            }["InteractiveMapClient.useCallback[renderMap]"]);
            cleanupPopups();
            // Create new SVG
            const newSvg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"])(mapRef.current).append('svg').attr('viewBox', `0 0 ${dimensions.width} ${dimensions.height}`).attr('width', '100%').attr('height', '100%').attr('class', 'absolute w-full h-full left-0 top-0');
            svgRef.current = newSvg.node();
            const multiPolygon = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$nzGeoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newZealandGeoJson"].geometry.coordinates;
            // Use requestAnimationFrame for smoother rendering
            requestAnimationFrame({
                "InteractiveMapClient.useCallback[renderMap]": ()=>{
                    // Render NZ outline
                    multiPolygon.forEach({
                        "InteractiveMapClient.useCallback[renderMap]": (polygonCoords)=>{
                            const feature = {
                                type: 'Feature',
                                properties: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$nzGeoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newZealandGeoJson"].properties,
                                geometry: {
                                    type: 'Polygon',
                                    coordinates: polygonCoords
                                }
                            };
                            newSvg.append('path').datum(feature).attr('d', path).attr('class', 'fill-none stroke-neutral-700 stroke-[0.5]');
                        }
                    }["InteractiveMapClient.useCallback[renderMap]"]);
                    ...
                    ;
                    const isInside = {
                        "InteractiveMapClient.useCallback[renderMap].isInside": (point)=>{
                            return multiPolygon.some({
                                "InteractiveMapClient.useCallback[renderMap].isInside": (polygonCoords)=>{
                                    const feature = {
                                        type: 'Feature',
                                        properties: {},
                                        geometry: {
                                    ...
                                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$geo$2f$src$2f$contains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__geoContains$3e$__["geoContains"])(feature, point);
                                }
                            }["InteractiveMapClient.useCallback[renderMap].isInside"]);
                        }
                    }["InteractiveMapClient.useCallback[renderMap].isInside"];
                    // Pre-compute which pixels are inside NZ
                    const pixelsToRender = [];
                    ...
                    function renderChunk() {
                        ...
                        for(let i = currentIndex; i < endIndex; i++){
                            ...
                            if (heat > 0.1) {
                                ...
                                rect.attr('class', 'pixel').style('fill', randomCamoColor).style('opacity', 0.8 + Math.random() * 0.2);
                            }
                        }
                        ...
                        if (currentIndex < pixelsToRender.length) {
                            ...
                            laserIntervalRef.current = setInterval({
                                "InteractiveMapClient.useCallback[renderMap].renderChunk": ()=>{
                                    shootRandomLaser();
                                }
                            }["InteractiveMapClient.useCallback[renderMap].renderChunk"], 300) // Reduced frequency for better performance
                            ;
                        }
                    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full pl-2 pr-2 md:pl-4 md:pr-4 lg:pl-0 lg:pr-0",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ref: mapRef,
            className: "w-full h-[85vh] md:h-[90vh] lg:h-[95vh] xl:h-screen m-0 p-0 bg-transparent relative overflow-hidden"
        }, void 0, false, {
            fileName: "[project]/src/app/(home)/Map/Map.tsx",
            lineNumber: 657,
            columnNumber: 13
...
_s1(InteractiveMapClient, "GwzVryR3yyvOoPU2l4HL04JNE/c=");
_c1 = InteractiveMapClient;
const __TURBOPACK__default__export__ = InteractiveMap;
var _c, _c1;
__turbopack_context__.k.register(_c, "InteractiveMap");
__turbopack_context__.k.register(_c1, "InteractiveMapClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(home)/Map/Map.tsx [app-client] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/(home)/Map/Map.tsx [app-client] (ecmascript)"));
}}),
}]);

//# sourceMappingURL=src_50d9d80f._.js.map