...
import { Heart, Users, Sparkles, ChevronLeft, ChevronRight, Play, Pause, MapPin } from 'lucide-react'
...
const ImageCarousel = ({ items }: { items: GalleryItem[] }) => {
    ...
    return (
        <div className="relative h-[28rem] w-full overflow-hidden rounded-lg" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd} style={{ touchAction: 'manipulation' }}>
                ...
                {items.map((item, index) => (
                    <div key={index} className="relative min-w-full h-full">
                        <div className="relative w-full h-full">
                            ...
                            <Image src={item.image} alt={item.title} fill className="object-cover bg-black object-center" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" priority={index === 0} draggable="false" />
                        </div>
        ...
        <section id="gallery" className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto mb-12">
                    ...
                    <p className="text-green-100 text-center text-sm md:text-base">Explore the physical social realm of New Zealand's Bitcoin, crypto and web3 community, forging friendships and connections; catalyzing collaboration, innovation, enterprise and industry.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <button className="group relative w-full overflow-hidden rounded-lg bg-gradient-to-br from-green-500 to-green-600 p-[1px] transition-all duration-300 hover:from-green-400 hover:to-green-500 hover:shadow-[0_0_35px_rgba(74,222,128,0.5)]">
                            <div className="relative bg-black/90 backdrop-blur-xl px-8 py-4 rounded-lg transition-all duration-300 group-hover:bg-black/80">
                                <div className="flex items-center justify-center gap-3">
                                    ...
                                    <span className="text-white font-semibold">Sponsor Our Meetups</span>
                                </div>
                            </div>
                        </button>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <StatBox icon={<MapPin className="w-6 h-6 text-green-400 mb-2" />} label="Meetup Locations" value={12} />
                        </div>
                    </div>
                </div>
            </div>
