  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      points: [
        ...
        <>Core developers Invited by UC Business school to teach the practical laboratory sessions of <a href="https://courseinfo.canterbury.ac.nz/GetCourseDetails.aspx?course=INFO363&occurrence=25S1(C)&year=2025" className="text-orange-400 hover:text-orange-300">INFO-361</a> (S1) UC</>,
      ...
      <div className="relative w-full max-w-5xl px-4 md:px-8 py-10 md:py-20">
        ...
        <div className="relative z-10">
          {timelineEvents.map((event, index) => {
            ...
            return (
              <div key={index} className="flex flex-col md:flex-row items-start md:items-center mb-16 md:mb-32 last:mb-0">
                ...
                <div className="pl-16">
                    ...
                    <h3 className="text-xl font-semibold text-orange-400 mb-3">{event.year}</h3>
                    <ul className="space-y-2">
                        {event.points.map((point, i) => (
                        <li key={i} className="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="orange" stroke="#f97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="mt-1 mr-2 flex-shrink-0">
                ...
                <div className="hidden md:flex md:items-center w-full">
                  ...
                  <div className="w-1/2 pr-8 md:pr-12 flex justify-end">
                    {isLeft ? (
                      ...
                      <div className="rounded-xl border border-orange-500 bg-zinc-800/80 backdrop-blur-sm p-4 md:p-6 shadow-xl w-full max-w-md">
                        <h3 className="text-2xl font-semibold text-orange-400 text-center mb-4">{event.year}</h3>
                        <ul className="mt-4 space-y-3">
                          {event.points.map((point, i) => (
                            <li key={i} className="flex items-start">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="orange" stroke="#f97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="mt-1 mr-3 flex-shrink-0">
                                <circle cx="12" cy="12" r="6"/>
                              </svg>
                  ...
                  <div className="w-1/2 pl-8 md:pl-12">
                    {!isLeft ? (
                      ...
                      <div className="rounded-xl border border-orange-500 bg-zinc-800/80 backdrop-blur-sm p-4 md:p-6 shadow-xl w-full max-w-md">
                        <h3 className="text-2xl font-semibold text-center text-orange-400 mb-4">{event.year}</h3>
                        <ul className="mt-4 space-y-3">
                          {event.points.map((point, i) => (
                            <li key={i} className="flex items-start">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="orange" stroke="#f97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="mt-1 mr-3 flex-shrink-0">
